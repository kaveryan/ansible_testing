    ...
    def get_command_output(self, shell_id, command_id):
        ...
        while not command_done:
            try:
                ...
                if stdout and (not chardet.detect(stdout)['encoding'] == 'utf-8'):
                    stdout = stdout.decode('gbk').encode('utf8')
                if stderr and (not chardet.detect(stderr)['encoding'] == 'utf-8'):
                    stderr = stderr.decode('gbk').encode('utf8')
